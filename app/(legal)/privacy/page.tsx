  ...
  return (
    <article className="max-w-none">
      ...
      <div className="mb-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-border/50 bg-background/50 p-4">
          <Cookie className="mb-2 h-5 w-5 text-primary" />
      ...
      <div className="space-y-6">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mb-3 text-muted-foreground">
                Lorsque vous utilisez FanTribe, nous collectons les informations suivantes :
              </p>
              <ul className="ml-6 list-disc space-y-2 text-muted-foreground">
                <li>
                  <strong className="text-foreground">Informations de compte :</strong> nom, adresse email, nom
                  d&apos;utilisateur, photo de profil
                </li>
                <li>
                  <strong className="text-foreground">Informations de profil :</strong> biographie, liens vers vos
                  réseaux sociaux, préférences
                </li>
                <li>
                  <strong className="text-foreground">Contenu :</strong> publications, commentaires, messages que
                  vous créez
                </li>
                <li>
                  <strong className="text-foreground">Informations de paiement :</strong> traitées de manière
                  sécurisée par nos partenaires (CinetPay, Stripe)
                </li>
                <li>
                  <strong className="text-foreground">Documents de vérification :</strong> pour les créateurs
                  souhaitant être vérifiés
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Certaines informations de votre profil sont publiques par défaut : nom
                d&apos;utilisateur, photo de profil, biographie et publications
                publiques.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mb-3 text-muted-foreground">Nous pouvons partager vos informations avec :</p>
              <ul className="ml-6 list-disc space-y-2 text-muted-foreground">
                <li>
                  <strong className="text-foreground">Prestataires de services :</strong> hébergement (Convex),
                  paiement (CinetPay, Stripe), CDN (Bunny), authentification (Clerk)
                </li>
                <li>
                  <strong className="text-foreground">Autorités légales :</strong> si requis par la loi ou pour
                  protéger nos droits
                </li>
                <li>
                  <strong className="text-foreground">Autres utilisateurs :</strong> selon vos paramètres de
                  confidentialité
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Nous ne vendons jamais vos données personnelles à des tiers. Nous ne
                partageons pas vos informations à des fins publicitaires tierces sans
        ...
        <section className="rounded-xl border border-border/30 bg-muted/20 p-6">
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <ul className="ml-6 list-disc space-y-2">
              ...
              <li>
                <strong className="text-foreground">Droit de rectification :</strong> corriger des données
                inexactes
              </li>
              <li>
                <strong className="text-foreground">Droit à l&apos;effacement :</strong> demander la suppression de
                vos données
              </li>
              <li>
                <strong className="text-foreground">Droit à la portabilité :</strong> recevoir vos données dans
                un format structuré
              </li>
              <li>
                <strong className="text-foreground">Droit d&apos;opposition :</strong> vous opposer à certains
                traitements
              </li>
              <li>
                <strong className="text-foreground">Droit de limitation :</strong> limiter le traitement de vos
                données
              </li>
            </ul>
            <div className="mt-4 rounded-lg bg-background/50 p-4">
              <p>
                ...
                <a href="mailto:privacy@fantribe.com" className="text-primary hover:underline">
        ...
        <section className="rounded-xl border border-border/30 bg-muted/20 p-6">
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <ul className="ml-6 list-disc space-y-2">
              <li>
                <strong className="text-foreground">Cookies essentiels :</strong> fonctionnement de base de la
                plateforme, authentification
              </li>
              <li>
                <strong className="text-foreground">Cookies de performance :</strong> analyse de l&apos;utilisation
                pour améliorer nos services
              </li>
              <li>
                <strong className="text-foreground">Cookies de préférences :</strong> mémoriser vos choix (thème,
                langue)
              </li>
            </ul>
            <p>
        ...
        <section className="rounded-xl border border-border/30 bg-muted/20 p-6">
          ...
          <div className="text-muted-foreground">
            <p>
              ...
              que votre pays de résidence. Nous nous assurons que ces transferts sont
              effectués conformément aux lois applicables et avec des garanties
              appropriées.
            </p>
          </div>
        </section>
        ...
        <section className="rounded-xl border border-border/30 bg-muted/20 p-6">
          ...
          <div className="text-muted-foreground">
            <p>
              FanTribe n&apos;est pas destiné aux personnes de moins de 18 ans. Nous ne
              collectons pas sciemment des données personnelles de mineurs. Si nous
              apprenons qu&apos;un mineur nous a fourni des données, nous les supprimerons
              immédiatement.
            </p>
          </div>
        </section>
        ...
        <section className="rounded-xl border border-border/30 bg-muted/20 p-6">
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <div className="space-y-2 rounded-lg bg-background/50 p-4">
              <p>
                <span className="font-medium text-foreground">Email confidentialité :</span>{" "}
                <a href="mailto:privacy@fantribe.com" className="text-primary hover:underline">
                  privacy@fantribe.com
                </a>
              </p>
              <p>
                <span className="font-medium text-foreground">Support général :</span>{" "}
