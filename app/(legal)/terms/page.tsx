    ...
    <article className="max-w-none">
      ...
      <div className="border-border/50 mb-12 border-b pb-8">
        ...
        <p className="text-muted-foreground text-lg">
          ...
          FanTribe. En accédant à notre plateforme, vous acceptez d&apos;être
      ...
      <div className="mb-12 grid gap-4 sm:grid-cols-3">
        <div className="border-border/50 bg-background/50 rounded-xl border p-4">
          <Scale className="text-primary mb-2 h-5 w-5" />
        ...
        <div className="border-border/50 bg-background/50 rounded-xl border p-4">
          <UserCheck className="text-primary mb-2 h-5 w-5" />
      ...
      <div className="space-y-6">
        <section className="border-border/30 bg-muted/20 rounded-xl border p-6">
          ...
          <div className="text-muted-foreground space-y-4">
            <p>
              En créant un compte ou en utilisant FanTribe, vous confirmez avoir
              lu, compris et accepté ces conditions d&apos;utilisation dans leur
              intégralité. Si vous n&apos;acceptez pas ces conditions, veuillez
              ne pas utiliser notre plateforme.
            </p>
            <p>
              FanTribe se réserve le droit de modifier ces conditions à tout
              moment. Les modifications entreront en vigueur dès leur
              publication sur la plateforme. Votre utilisation continue de
              FanTribe après ces modifications constitue votre acceptation des
        ...
        <section className="border-border/30 bg-muted/20 rounded-xl border p-6">
          ...
          <div className="text-muted-foreground space-y-4">
            ...
            <ul className="ml-6 list-disc space-y-2">
              ...
              <li>
                Ne pas être interdit d&apos;utiliser nos services en vertu des
                lois applicables
              </li>
              <li>
        ...
        <section className="border-border/30 bg-muted/20 rounded-xl border p-6">
          ...
          <div className="text-muted-foreground space-y-4">
            <p>
              Lors de la création de votre compte, vous vous engagez à fournir
              des informations véridiques, exactes et complètes. Vous êtes
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Vous conservez tous les droits de propriété intellectuelle sur
                le contenu que vous publiez sur FanTribe. En publiant du
                contenu, vous nous accordez une licence mondiale, non exclusive,
                libre de redevances pour utiliser, reproduire et distribuer ce
                contenu dans le cadre de nos services.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="text-muted-foreground ml-6 list-disc space-y-2">
                ...
                <li>
                  Respecte les lois applicables en matière de protection des
                  mineurs
                </li>
              </ul>
            </div>
        ...
        <section className="border-border/30 bg-muted/20 rounded-xl border p-6">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Les créateurs peuvent proposer des abonnements payants pour
                accéder à leur contenu exclusif. Les prix sont fixés par les
                créateurs conformément à nos directives.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                acceptez également les conditions de ces prestataires de
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Les abonnements sont généralement non remboursables, sauf dans
                les cas prévus par la loi ou notre politique de remboursement
        ...
        <section className="border-border/30 bg-muted/20 rounded-xl border p-6">
          ...
          <div className="text-muted-foreground">
            <p>
              ...
              protégés par les lois internationales sur le droit d&apos;auteur,
        ...
        <section className="border-border/30 bg-muted/20 rounded-xl border p-6">
          ...
          <div className="text-muted-foreground space-y-4">
            <p>
              Nous pouvons suspendre ou résilier votre compte immédiatement,
              sans préavis ni responsabilité, pour quelque raison que ce soit,
              notamment si vous violez ces conditions d&apos;utilisation.
            </p>
            <p>
              Vous pouvez supprimer votre compte à tout moment via les
              paramètres de votre profil. La suppression de votre compte
              entraînera la perte de tout contenu et données associés.
            </p>
          </div>
        </section>
        ...
        <section className="border-border/30 bg-muted/20 rounded-xl border p-6">
          ...
          <div className="text-muted-foreground">
            <p>
              FanTribe est fourni &quot;tel quel&quot; sans garantie
              d&apos;aucune sorte. Nous ne serons pas responsables des dommages
              indirects, accessoires, spéciaux ou consécutifs résultant de votre
